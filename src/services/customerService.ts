...
export const getOrCreateCustomer = async (
  ...
  try {
    ...
    const newCustomerData: Omit<Customer, 'id'> = {
      ...
      ...(additionalData?.telegramUserId && { telegramUserId: additionalData.telegramUserId }),
      totalPurchases: 0,
      totalSpent: 0,
      vehiclesPurchased: [],
      testDrives: [],
      ...
      ...(additionalData?.preferredContact && { preferredContact: additionalData.preferredContact }),
