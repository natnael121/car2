        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-blue-50 rounded-lg p-4">
              <p className="text-sm text-blue-700 font-medium mb-1">Available Vehicles</p>
              <p className="text-3xl font-bold text-blue-900">{stats.totalInventory}</p>
            </div>
            ...
            <div className="bg-orange-50 rounded-lg p-4">
              <p className="text-sm text-orange-700 font-medium mb-1">Avg. Vehicle Value</p>
              <p className="text-3xl font-bold text-orange-900">
                {stats.totalInventory > 0 ? formatCurrency(stats.totalValue / stats.totalInventory) : '$0'}
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="border border-gray-200 rounded-lg p-3">
                <p className="text-xs text-gray-600 mb-1">This Month Sales</p>
                <p className="text-xl font-bold text-gray-900">{stats.salesThisMonth}</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-3">
                <p className="text-xs text-gray-600 mb-1">Active Leads</p>
                <p className="text-xl font-bold text-gray-900">{stats.activeLeads}</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-3">
                <p className="text-xs text-gray-600 mb-1">Pending Test Drives</p>
                <p className="text-xl font-bold text-gray-900">{stats.pendingTestDrives}</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-3">
                <p className="text-xs text-gray-600 mb-1">Trade-In Offers</p>
                <p className="text-xl font-bold text-gray-900">{stats.pendingTradeIns}</p>
              </div>
            </div>
          </div>
        </div>
